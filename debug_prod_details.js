...
async function debugProductDetails(nodeId, productId) {
    const token = await getZettiToken();
    const url = `${ZETTI_CONFIG.api_url}/v2/${nodeId}/products/${productId}`;
...
async function run() {
    try {
        await debugProductDetails('2378041', '134940000000000634');
    } catch (e) {
