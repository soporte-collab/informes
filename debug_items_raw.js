...
async function debugInvoiceItems(nodeId) {
    const token = await getZettiToken();
    const url = `${ZETTI_CONFIG.api_url}/v2/${nodeId}/sales-receipts/search?include_items=true`;
    // The format in the code is 2026-01-28T00:00:00.000-0300
    const body = {
        emissionDateFrom: `2026-01-28T00:00:00.000-0300`,
        emissionDateTo: `2026-01-28T23:59:59.000-0300`,
        pageSize: 10
    };
...
async function run() {
    try {
        await debugInvoiceItems('2378041');
    } catch (e) {
